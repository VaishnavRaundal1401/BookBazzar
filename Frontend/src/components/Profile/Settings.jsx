...
const Settings = () => {
  ...
  return (
    <>
      {!ProfileData && (<div className='w-full h-[100%] flex itmes-center justify-center'><Loader/></div>)}
      {ProfileData && (
        <div className='h-[100%] p-0 md:p-4 text-zinc-100'>
          ...
          <div className='mt-4 flex flex-col'>
            ...
            <textarea className='p-2 rounded bg-zinc-800 mt-2 font-sembold' name="address" rows="5" placeholder='Address' value={Value.address} onChange={change}/>
          </div>
