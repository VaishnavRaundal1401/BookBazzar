  ...
  return (
    <div className='h-[75vh] flex flex-col md:flex-row items-center justify-center'>
      <div className='w-full lg:w-3/6 flex flex-col items-center lg:items-start justify-center'>
        ...
        <div className='mt-8'>
            <Link to='/all-books' className='text-xl lg:text-2xl font-semibold text-yellow-100 border border-yellow-100 px-10 py-3 hover:bg-zinc-800 rounded-full'>Discover Books</Link>
        </div>
      </div>
